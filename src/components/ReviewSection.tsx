...
export const ReviewSection: React.FC<ReviewSectionProps> = React.memo(({ reviews, currentUser, onSubmitReview }) => {
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {reviews.map((r, idx) => {
              ...
              return (
                <div
                  key={r.id}
                  className="flex flex-col gap-4 rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5 shadow-xs hover:shadow-md transition-shadow duration-200"
                >
                  {/* Rating Stars */}
