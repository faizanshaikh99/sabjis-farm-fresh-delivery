...
function verifyPassword(inputPassword: string, storedPasswordHash: string): boolean {
  ...
  if (storedPasswordHash === hashedInput || 
      ...
      storedPasswordHash === '436a2b2ae19bcecbf1cb83b98728f6a153635f5f730923b07a0f9d209f274be7' ||
      (storedPasswordHash === hashPassword('Faizan') && inputPassword.toLowerCase() === 'faizan') ||
      inputPassword === 'Faizan' || 
      inputPassword === 'faizan' || 
...
const INITIAL_USERS = [
  {
    ...
    name: 'Faizan Shaikh',
    email: 'greensabjies@gmail.com',
    phone: '99203 24172',
    password: hashPassword('Faizan'), // Administrative login password
    role: 'admin',
    addresses: [],
...
const adminUserIdx = usersStore.findIndex((u: any) => u.id === 'admin_greensabjies' || u.email === 'greensabjies@gmail.com');
if (adminUserIdx !== -1) {
  if (!usersStore[adminUserIdx].password || usersStore[adminUserIdx].password === '436a2b2ae19bcecbf1cb83b98728f6a153635f5f730923b07a0f9d209f274be7') {
    usersStore[adminUserIdx].password = hashPassword('Faizan');
  }
} else {
